...
class InterHumanDataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        music = np.zeros((self.max_gt_length, 54), dtype=np.float32)        
...
if __name__ == "__main__":
    import yaml
    config_path = "/scratch/gilbreth/gupta596/MotionGen/DualFlow/dance/configs/datasets_interhuman_prerit.yaml"
    ...
    for i in range(10):
        data = dataset[i]
        print(data[0], data[1], data[2].shape, data[3].shape, data[4])
